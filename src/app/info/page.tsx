...
export default function InfoPage() {
  ...
  const handleCopyEmail = async () => {
    try {
      ...
      showToast(
        lang === 'id' ? 'Gagal menyalin email.' : 'Failed to copy email.',
        'error'
      )
    }
  }
  ...
  return (
    <div className="py-4 pb-28 max-w-3xl mx-auto">
      ...
      <div className="mb-6">
        <Link
          href="/learn"
          className="inline-flex items-center gap-2 text-sm text-text-muted hover:text-primary transition-colors font-medium bg-surface px-4 py-2 rounded-full border border-border-color shadow-sm"
        >
          <ArrowLeft size={16} />
      ...
      <div className="relative overflow-hidden rounded-3xl bg-surface border border-border-color p-8 md:p-10 mb-8 shadow-sm text-center">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-text-main tracking-tight mb-3">
            KanjiPaham
          </h1>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-base font-bold text-text-main group-hover:text-[#0A66C2] transition-colors">
                  bagasrr17
                </p>
          ...
          {/* Instagram */}
          <a
            href="https://instagram.com/barra.adhan17"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-base font-bold text-text-main group-hover:text-[#E1306C] transition-colors">
                  @barra.adhan17
                </p>
                <p className="text-xs text-text-subtle">instagram.com/barra.adhan17</p>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between p-5 rounded-2xl border-2 border-border-color bg-surface hover:border-primary hover:shadow-md transition-all duration-200">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base font-bold text-text-main break-all">
                    {email}
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-border-color/50">
              <a
                href={`mailto:${email}`}
                className="flex-1 py-2 px-3 text-xs font-bold rounded-xl bg-primary text-white hover:bg-primary-hover transition-colors text-center shadow-sm"
              >
      ...
      <div className="rounded-3xl border border-border-color bg-surface p-6 md:p-8 shadow-sm mb-8">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 text-center sm:text-left">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-secondary text-white font-serif text-3xl font-extrabold flex items-center justify-center flex-shrink-0 shadow-md">
            B
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
              <div>
                <h3 className="text-xl font-bold text-text-main">
                  Bagas Ramadhan (bagasrr)
                </h3>
                <p className="text-xs font-semibold text-primary">
                  Creator & Lead Developer of KanjiPaham
                </p>
              </div>
